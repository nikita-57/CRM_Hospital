...
from .views import Dashboard, PatientList, PatientCreate, PatientDetail, PatientSoftDelete, PatientRestore
from .views import PatientUpdate, AdultPatientList, ChildrenPatients
